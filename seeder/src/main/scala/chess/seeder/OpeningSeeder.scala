...
/** Seeds an [[OpeningRepository]] from Lichess TSV or CSV classpath resources.
  *
  * Parsing is delegated to [[OpeningParser]] from the core project. This object handles only the effectful
  * write side: loading parsed openings into a repository.
  */
