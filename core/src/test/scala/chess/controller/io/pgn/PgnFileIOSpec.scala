...
class PgnFileIOSpec extends AnyWordSpec with Matchers {

  val pgnIO: PgnIO = new PgnFileIO

  "PgnFileIO.save" should {
    ...
    "handle a single move" in {
      pgnIO.save(Vector("e4")) shouldBe "1. e4"
    }
