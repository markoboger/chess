...
/** PGN-specific game serialization interface.
  *
  * Unlike [[chess.io.FileIO]] which serializes a single board position, PGN
  * represents a game as a sequence of moves. The save/load contract therefore
  * operates on move lists rather than boards.
  */
trait PgnIO:
