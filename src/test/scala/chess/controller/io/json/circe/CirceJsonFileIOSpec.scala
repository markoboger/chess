...
class CirceJsonFileIOSpec extends AnyWordSpec with Matchers {

  val fileIO: FileIO = new CirceJsonFileIO

  "CirceJsonFileIO" should {
    ...
    "be usable through the FileIO interface" in {
      // Verify polymorphic usage through the trait
